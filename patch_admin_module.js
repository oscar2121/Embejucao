...
const chartsEndStr = "{/* GESTIÓN DE USUARIOS */}";
...
// A. Remove "Eliminar" button
const eliminarBtnRegex = /\{\s*u\.nombre !== 'Administrador' && \(\s*<button\s*onClick=\{[^}]*eliminarUsuario[^}]*\}\s*style=\{[^}]*\}\s*>\s*Eliminar\s*<\/button>\s*\)\s*\}/;
